...
def create_db_with_tables(conn):
    with conn.cursor() as cur:
        ...
        cur.execute(
            "CREATE TABLE IF NOT EXISTS humans.users (id varchar(36) NOT NULL,firstName varchar(255) default NULL,lastName varchar(255) default NULL,email varchar(255) default NULL);"
        )
    conn.commit()
